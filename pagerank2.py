...
class WebGraph():
    ...
    def search(self, pi, query='', max_results=10, s_weight = .03, power =30):
        ...
        for i in range(n):
            new, score, weight_w = 0,0,0

            url_ = self._index_to_url(i)

            if url_satisfies_query_s(url_, query):
                new+=1
                weight_w+=s_weight
            ...
            for word in range(10):
                ...
                if url_satisfies_query_s(url_,w):
                    new+=1
                    weight_w+=S[word][1]**power
        ...
        for i in range(n):
            ...
            if url_satisfies_query(url,query):
                ...
                matches += 1
def url_satisfies_query_s(url,query):
    satisfies = False
    terms = query.split()
...
if __name__=='__main__':
    ...
    g.search(pi, query=args.search_query, max_results=args.max_results, power=args.power, s_weight=args.s_weight)
